...
// Import the NavigationHelper instead of direct chat_screen import
import 'package:campus_conn/messages/utils/test_navigation.dart';
...
class _ChatListScreenState extends ConsumerState<ChatListScreen>
  ...
  void _navigateToChat(BuildContext context, Chat chat) {
    // Use the helper class to navigate
    NavigationHelper.navigateToChat(context, chat);
  }

  /// Show new message modal
  void _showNewMessageModal(BuildContext context) {
    // Ensure all users are loaded before showing the sheet
